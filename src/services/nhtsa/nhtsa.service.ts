...
import { VehicleVariableInterface } from '@interfaces/nhtsa/vehicle-variable';
import { DecodedVinItem } from '@interfaces/vin/decoded-vin.item';
...
import { I18nNamespace } from '@interfaces/i18n/i18n-namespace';
import { NhtsaVinResponseEntity } from '@interfaces/nhtsa/nhtsa-vin-response-entity';
import { RuntimeException } from '@nestjs/core/errors/exceptions/runtime.exception';
// eslint-disable-next-line
import { VehicleVariableDocument } from '@services/mongoose/schemas/vehicle-variable.schema';
import { NhtsaVinResponseEntityProxy } from '@interfaces/nhtsa/nhtsa-vin-response-entity-proxy';
// eslint-disable-next-line
